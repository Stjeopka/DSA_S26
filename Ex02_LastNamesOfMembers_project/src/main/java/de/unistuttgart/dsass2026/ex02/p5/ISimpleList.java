...
public interface ISimpleList<T extends Comparable<T>> {
     ...
     * I.e. the new element becomes the element at index 0.
     *
     ...
     * It should use the BubbleSort algorithm, but not access any element by its
     * index, i.e., it MUST NOT use the getElement() method. It should therefore
     * avoid the issues you stated in Aufgabe 5 (a).
     */
    public void sort();
}